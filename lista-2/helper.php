...
function mb_substr_replace($str, $repl, $start, $length = null)  : string
{
...
Class Helper {
  ...
  public static function gameOverDraw() : string
  {
    $draw = "
...
";
  ...
  public static function winDraw() : string
  {
    $draw = "
...
";
  ...
  public static function playerDraw(int $number) : string
  {
    $player[1] = "
...
";
  ...
  public static function lifeDraw(int $param) : string
  {
    $life = array();
